...
features:
    - label: Sky brightness sensor with mag/arcsec² output
      icon: fa-moon
    - label: Infrared cloud detection sensor
      icon: fa-cloud
...
buttons:
  - url: /products/AMSKY02/
    text: AMSKY02 (newer version)
...
> **A newer version is available:** [AMSKY02](/products/AMSKY02/) features dual SQM sensors, a high-resolution pixel thermopile array, and an improved water-pooling resistant enclosure.

AMSKY01 is a versatile, all-in-one sensor for astronomers and observatories.
